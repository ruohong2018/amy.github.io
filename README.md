...
### [我的博客在这里 &rarr;](http://amy.github.io)
...
我的博客仓库——`amy.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`RU040NG'sBlog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone git@github.com:Huxpro/huxBlog-boilerplate.git
```

**[在这里预览模板 &rarr;](http://huangxuan.me/RU040NG'sBlog-boilerplate/)**
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/ruohong2018/amy.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`amy.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: RU0-40NG's Blog             # 你的博客网站标题
SEOTitle: RU0-40NG's Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: ruohong2018     # 你的github账号
weibo_username: happiness0522      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-rh.jpg     #你的大头贴，请使用绝对地址.
```
...
---
layout:     keynote
iframe:     "http://ruohong.online/js-module-7day/"
---
```
...
ga_domain: ruohong.online			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“RU040NG's Blog”** 但是我想要在搜索的时候显示 **“若泓的博客 | RU040NG's Blog”** ，这个就需要SEO Title来定义了。
...
2. 黄玄的模板是从这里[IronSummitMedia/startbootstrap-clean-blog-jekyll](https://github.com/IronSummitMedia/startbootstrap-clean-blog-jekyll)  fork 的。 感谢这个作者

2. 感谢[@BrucZhaoR](https://github.com/BruceZhaoR)
